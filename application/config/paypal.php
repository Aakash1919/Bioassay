 ...
 */
$config['APIUsername'] = $config['Sandbox'] ? 'programmer.ck_api1.gmail.com' : 'order_api1.bioassaysys.com';
$config['APIPassword'] = $config['Sandbox'] ? '1366907318' : 'S962CVFGRHLYWWR3';
$config['APISignature'] = $config['Sandbox'] ? 'AAq13O52RXUl0Hg8MGGWgxmQGCh2AjJ0ARoVO-anNTCOOSoxpI3uT-QH' : 'AOArC1f4IdjkICg6ox2mMj-gLIE1Aa9a2K3DK1UDQnrfvSq19JMpQKur';
...
$config['PayFlowVendor'] = $config['Sandbox'] ? 'bioassay' : '';
 ...
 */
$config['DeveloperEmailAccount'] = 'programmer.ck@gmail.com';
