	...
	<article class="content-right-btm" style="margin-top:0px;">
		<div class="new-products" style="margin-top:0px;">
			<div class="new-products-title">
				<h1>
					<span>
						Welcome to BioAssay Systems' Career Center
					</span>
				</h1>
			</div>
			<div class="new-products-list">
				...
				<div style="text-align: center;">
					<img src="images/BAS.HR.718x360.jpg" width="718" height="360" alt="BioAssay Systems Careers">
				</div>
				...
				<div style="padding: 15px;">
					...
					<br />
					<br />
					It was these challenges and opportunities that drove the founding of BioAssay Systems. The founders of BioAssay Systems have over 50 years of extensive experiences in modern drug discovery. Over the past 15 years, we have developed over 200 assay kits for drug discovery and life sciences research. In addition to the assay products, we also offer analytical services. Our technical support team consists of real lab scientists. Customer's questions are answered directly by the same scientists who developed our assay kits.
					<br />
					<br />
					At BioAssay Systems, we pride ourselves on offering the highest possible quality and the most convenient assay products to help accelerate biomedical research and discovery.
					<br />
					<br />
					...
					<p>
						...
						is an equal opportunity employer and values the diversity of our employees.
					</p>
				</div>
			</div>
			<div class="clear">
