...
foreach ($item as $i) {
  ...
  <section class="content-area">
    <div class="left_content">
             <div class="prod_title"><h1><?php  if(!empty($name)){ $aa= mb_convert_encoding($name, "HTML-ENTITIES", "UTF-8");
                                            echo $aa;  } ?></h1>
              </div>
  ...
  <div class="bs_css-panes">
        <div id="product-overview" class="tabbox">
               <div class="bs_tab_cont">
                        ...
                        <?php } ?>
                        <?php 
                        if(!empty($product_overview->application1)){ ?>
						...
						<?php } ?>
                          ...
                          <?php 
                        if(!empty($product_overview->keyfeature1)){ ?>
