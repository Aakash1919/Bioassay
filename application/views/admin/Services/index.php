                                    ...
                                    <div class="col-md-6">
                                     <div class="input-group">
                                        ...
                                        <div class="input-group-btn">
                                         ...
                                         -->
                                         <a href="#" class="btn btn-primary pull-right"><span class="fa fa-plus-square-o"></span> Add Services</a>
                                    </div>
                                	</div>
                                            ...
                                            <?php foreach ($items as $i){?>                                            
                                                <tr id="trow_1">
                                                  <td class="text-center"><?php echo $i->id;?></td>
                                                    ...
                                                    <td>
                                                        <a href="/admin/services/edit/<?php echo $i->id;?>" class="btn btn-default btn-rounded btn-condensed btn-sm"><span class="fa fa-pencil"></span></a>
                                                        <a href="/admin/services/delete/<?php echo $i->id;?>" class="btn btn-danger btn-rounded btn-condensed btn-sm"><span class="fa fa-times"></span></a>
                                                    </td>
                                                </tr>
                                              <?php } ?> 
