  <ul class="breadcrumb">
    <li><a href="<?php echo base_url();?>admin/dashboard/index">Seo</a></li>                    
                                            ...
                                            <?php foreach ($items as $i){?>                                            
                                                <tr id="trow_1">
                                                  ...
                                                  <td><?php echo $i->Description;?></td>
                                                    <td>
                                                        <a href="/admin/seo/edit/<?php echo $i->id;?>" class="btn btn-default btn-rounded btn-condensed btn-sm"><span class="fa fa-pencil"></span></a>
