...
<head>
    <meta charset="utf-8">
    <title>Bioassay Systems - Order Cancelled</title>
...
<div class="container">
    <div class="row clearfix">
        <div class="col-md-12 column">
            ...
            <h2 align="center">PayPal Checkout - Order Cancelled</h2>
            
            <div class="alert alert-info">
                <p>The payment was not processed because the order was cancelled.</p>
            </div>
            <a class="btn btn-primary" href="/checkout">Start over</a>
        </div>
    </div>
</div>
</body>
